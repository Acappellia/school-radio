...
{id:"text_display",Tags:["blackboard","bb_text_objective2"],text:[{text:"· 找到给电台用的电池",color:"gray"}],transformation:[1,-0.05,0,-2, 0.05,1,0,1.2, 0,0,1,-0.55, 0,0,0,1.5],background:0},\
{id:"text_display",Tags:["blackboard","bb_text_objective3"],text:[{text:"· 用电台搜寻外界的消息",color:"gray"}],transformation:[1,-0.02,0,-1.8, 0.02,1,0,0.9, 0,0,1,-0.55, 0,0,0,1.5],background:0},\
{id:"text_display",Tags:["blackboard","bb_text_objective4"],text:[{text:"· 保护好凪！！",color:"gray"}],transformation:[1,0,0,-2.2, 0,1,0,0.5, 0,0,1,-0.55, 0,0,0,1.5],background:0},\
]}
