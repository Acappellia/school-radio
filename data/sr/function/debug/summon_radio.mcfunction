...
{id:"text_display",Tags:["radio","radio_text_pre"],text:{text:"FM",color:"black"},background:0,brightness:{block:15,sky:15},transformation:{translation:[-0.27,0.47,0.4],scale:[0.3,0.3,0.3],left_rotation:[1,0,0,0],right_rotation:[1,0,0,0]}},\
{id:"text_display",Tags:["radio","radio_text_a"],text:{text:"111",color:"black"},background:0,brightness:{block:15,sky:15},transformation:{translation:[-0.05,0.4,0.4],scale:[0.6,0.6,0.6],left_rotation:[1,0,0,0],right_rotation:[1,0,0,0]}},\
...
{id:"text_display",Tags:["radio","radio_text_b"],text:{text:"1",color:"black"},background:0,brightness:{block:15,sky:15},transformation:{translation:[0.2,0.4,0.4],scale:[0.6,0.6,0.6],left_rotation:[1,0,0,0],right_rotation:[1,0,0,0]}},\
]}
