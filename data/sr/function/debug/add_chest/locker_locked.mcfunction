...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon item_display ~ ~ ~ {Tags:["new_loot","lootable","locker_locked"],item:{id:"feather",count:1,components:{item_model:"minecraft:school004"}}}
...
setblock ~ ~ ~ trapped_chest{LootTable:"sr:chest/locker_locked",CustomName:"储物柜"}