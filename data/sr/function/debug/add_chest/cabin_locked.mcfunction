...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon item_display ~ ~ ~ {Tags:["new_loot","lootable","cabin"],item:{id:"feather",count:1,components:{item_model:"minecraft:school005"}}}
