...
execute if score #ghast_motion sr matches -80..80 run data modify entity @s Motion[0] set value 0.0d
execute if score #ghast_motion_2 sr matches -80..80 run data modify entity @s Motion[2] set value 0.0d
