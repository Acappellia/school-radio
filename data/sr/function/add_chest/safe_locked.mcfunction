...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon item_display ~ ~ ~ {Tags:["untouched","new_loot","lootable","safe_locked"],item:{id:"feather",count:1,components:{item_model:"minecraft:safe_locked"}}}
...
setblock ~ ~ ~ trapped_chest{LootTable:"sr:chest/safe_locked",CustomName:"保险箱"}