...
execute align xyz positioned ~0.5 ~0.5 ~0.5 run summon item_display ~ ~ ~ {Tags:["untouched","new_loot","lootable","long"],item:{id:"feather",count:1,components:{item_model:"minecraft:chest_long_c"}}}
