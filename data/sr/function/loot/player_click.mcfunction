...
tag @s add searcher
execute anchored eyes positioned ^ ^ ^ run function #bs.raycast:run {with:{ignored_blocks:"#sr:ignore_blocks",on_targeted_block:"execute as @p[tag=searcher] run function sr:loot/reg_chest"}}
