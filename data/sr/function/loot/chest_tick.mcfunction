...
execute if score @s p_ability_search_level matches 3 if score @s p_search_tick matches 40 run return run function sr:loot/chest_replace_loot with storage sr:tmp lootchest_info
execute if score @s p_search_tick matches 41 at @s run playsound item.armor.equip_chain player @s ~ ~ ~ 1 0.8
execute if score @s p_ability_search_level matches 2 if score @s p_search_tick matches 60 run return run function sr:loot/chest_replace_loot with storage sr:tmp lootchest_info
