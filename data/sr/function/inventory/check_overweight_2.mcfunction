...
execute if score @s p_weight matches 48..73 run return run function sr:inventory/heavy_weight
execute if score @s p_weight matches 74.. run return run function sr:inventory/overweight